...
func XTMod() string {
	...
	if path, err := ModuleVersion("github.com/go-xt/xt/v2"); err == nil {
		// $GOPATH/pkg/mod/github.com/go-xt/xt@v2
		return filepath.Join(cachePath, path)
	}
	// $GOPATH/src/github.com/go-xt/xt
	return filepath.Join(gopath, "src", "github.com", "go-xt", "xt")
}
